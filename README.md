...
!\[App Screenshot](https://via.placeholder.com/800x500.png?text=Preview+Image+Coming+Soon)
...
2\.  Run `Chromium\_Theme\_Studio-v2.exe`.
...
5\.  If '.zip' does not work, try unpacking it first.
